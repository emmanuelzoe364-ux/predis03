...
def get_all_data_parallel(main_t, tf, lb, refresh_id):
    tickers = [main_t, "PAXG-USD", "BTC-USD", "ETH-USD", "USDT-USD"]
    results = {}
...
if main_df.empty:
    ...
    p_c, b_c, e_c, u_c = sync("PAXG-USD"), sync("BTC-USD"), sync("ETH-USD"), sync("USDT-USD")
    ...
    fig.update_layout(height=1400, template="plotly_white", xaxis_rangeslider_visible=False, showlegend=True, font=dict(color="black"), margin=dict(t=80, b=50, l=10, r=10))
