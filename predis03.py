...
with st.sidebar:
    ...
    timeframe = st.selectbox("Interval", ["1m", "5m", "15m", "30m", "1h", "4h", "1d", "1mo"], index=1) 
    lookback = st.selectbox("Data Lookback", ["1d", "3d", "7d", "1mo", "3mo", "30y"], index=2)
...
if main_df.empty:
    ...
    freq_map = {"1m": 1, "5m": 5, "15m": 15, "30m": 30, "1h": 60, "4h": 240, "1d": 1440, "1mo": 43800}
